...
export const REGIONS: RegionData[] = [
  ...
  },
  {
    ...
    artists: [
      ...
      { en: 'Rabah Saqer', ar: 'رابح صقر' },
      { en: 'Khaled Abdul Rahman', ar: 'خالد عبد الرحمن' },
      { en: 'Abdul Kareem Abdul Qader', ar: 'عبد الكريم عبد القادر' },
    ],
  },
  {
    key: 'iraq',
  ...
  },
  {
    ...
    artists: [
      ...
      { en: 'Dahmane El Harrachi', ar: 'دحمان الحراشي' },
      { en: 'Abdelwahab Doukkali', ar: 'عبد الوهاب الدكالي' },
      { en: 'Abdelhadi Belkhayat', ar: 'عبد الهادي بلخياط' },
    ],
  },
];
